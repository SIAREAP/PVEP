...
try:
    ...
    class _DummyGym:
        class Env:  # minimal stand-in for type inheritance
            pass

    class _DummySpaces:
        class Space:  # minimal stand-in for issubclass checks
            pass
...
class StateSet:
    ...
    def __init__(self,state_representation,end_condition):
        ...
        if not _GYM_AVAILABLE:
            raise RuntimeError("gymnasium is required to use StateSet/AdhocReasoningEnv.")
